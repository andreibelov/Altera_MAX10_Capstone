...
# Synopsys Design Constraint file
...
create_clock -period "5.0  MHz" -name clk_spi_ext [get_ports {GSENSOR_SCLK}]
...
# set_input_delay -max -clock [get_clocks {u3|altpll_0|sd1|pll7|clk[0]}] 0.0 [get_ports {ARDUINO_IO[1] ARDUINO_IO[2] ARDUINO_RESET_N}]
# set_input_delay -min -clock [get_clocks {u3|altpll_0|sd1|pll7|clk[0]}] -0.0 [get_ports {ARDUINO_IO[1] ARDUINO_IO[2] ARDUINO_RESET_N}]
...
set_output_delay -max -clock [get_clocks {u3|altpll_0|sd1|pll7|clk[0]}] 0.0 [get_ports {ARDUINO_IO[3]}]
set_output_delay -min -clock [get_clocks {u3|altpll_0|sd1|pll7|clk[0]}] -0.0 [get_ports {ARDUINO_IO[3]}]
...
# Set Multicycle Path
#**************************************************************
set_multicycle_path -from [get_clocks {clk_dram_ext}] -to [get_clocks {u3|altpll_0|sd1|pll7|clk[0]}] -setup 2
